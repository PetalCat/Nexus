...
See @/path/to/dev/Nexus/notes.md for current project notes and @/path/to/dev/Nexus/codex-advising/README.md for Codex advisory and research context.

See @/path/to/dev/Nexus/HANDOFF-INDEX.md for the top-level handoff map and @/path/to/dev/Nexus/WHO-TO-USE.md for the quick chooser.
