...
// mirror this state. The old PUT /api/auth/me/ghost HTTP endpoint was removed
// in #33 (no callers); any future client ghost UI calls `updatePresence()`
// via a fresh, purpose-built endpoint.
// Centralized 2026-04-17 (#34, codex-review/27); ghost endpoint retired #33;
// dead client stores (authStore/socialStore) retired #41/#42.
