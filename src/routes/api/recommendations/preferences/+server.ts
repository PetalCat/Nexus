...
/**
 * GET/PUT `/api/recommendations/preferences` is the one canonical endpoint
 * for the RecProfileConfig tuning blob. Every boundary (this route and the
 * `/api/user/recommendations/preferences` alias below) validates via zod.
 */
